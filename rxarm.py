...
class RXArmThread(QThread):
    ...
    def __init__(self, rxarm, parent=None):
        ...
        """
        self.pid_gains={rxarm.joint_names[0]:[5000,0,9000],rxarm.joint_names[1]:[5000,0,500],rxarm.joint_names[2]:[2000,300,0],rxarm.joint_names[3]:[800,100,0],rxarm.joint_names[4]:[640,100,3600],rxarm.joint_names[5]:[640,10,3600]}
